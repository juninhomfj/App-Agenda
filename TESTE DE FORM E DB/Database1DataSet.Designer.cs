...
namespace App_Agenda {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class TableDataTable : global::System.Data.TypedTableBase<TableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public TableRow AddTableRow(string Nome, string Celular, string Email, bool Client) {
...
namespace App_Agenda.Database1DataSetTableAdapters {
    ...
    public partial class TableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Table] WHERE (([ContactId] = @Original_ContactId) AND ((@IsNull_Nome = 1 AND [Nome] IS NULL) OR ([Nome] = @Original_Nome)) AND ((@IsNull_Celular = 1 AND [Celular] IS NULL) OR ([Celular] = @Original_Celular)) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)) AND ((@IsNull_Client = 1 AND [Client] IS NULL) OR ([Client] = @Original_Client)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Table] ([Nome], [Celular], [Email], [Client]) VALUES (@Nome, @" +
                "Celular, @Email, @Client);\r\nSELECT ContactId, Nome, Celular, Email, Client FROM " +
                "[Table] WHERE (ContactId = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Table] SET [Nome] = @Nome, [Celular] = @Celular, [Email] = @Email, [Client] = @Client WHERE (([ContactId] = @Original_ContactId) AND ((@IsNull_Nome = 1 AND [Nome] IS NULL) OR ([Nome] = @Original_Nome)) AND ((@IsNull_Celular = 1 AND [Celular] IS NULL) OR ([Celular] = @Original_Celular)) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)) AND ((@IsNull_Client = 1 AND [Client] IS NULL) OR ([Client] = @Original_Client)));
SELECT ContactId, Nome, Celular, Email, Client FROM [Table] WHERE (ContactId = @ContactId)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::App_Agenda.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ContactId, Nome, Celular, Email, Client FROM dbo.[Table]";
        ...
        public virtual int Delete(int Original_ContactId, string Original_Nome, string Original_Celular, string Original_Email, global::System.Nullable<bool> Original_Client) {
            ...
            if ((Original_Client.HasValue == true)) {
                ...
                this.Adapter.DeleteCommand.Parameters[8].Value = ((bool)(Original_Client.Value));
            }
            else {
        ...
        public virtual int Insert(string Nome, string Celular, string Email, global::System.Nullable<bool> Client) {
            if ((Nome == null)) {
            ...
            if ((Client.HasValue == true)) {
                this.Adapter.InsertCommand.Parameters[3].Value = ((bool)(Client.Value));
            }
            else {
        ...
        public virtual int Update(string Nome, string Celular, string Email, global::System.Nullable<bool> Client, int Original_ContactId, string Original_Nome, string Original_Celular, string Original_Email, global::System.Nullable<bool> Original_Client, int ContactId) {
            if ((Nome == null)) {
            ...
            if ((Client.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[3].Value = ((bool)(Client.Value));
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Nome, string Celular, string Email, global::System.Nullable<bool> Client, int Original_ContactId, string Original_Nome, string Original_Celular, string Original_Email, global::System.Nullable<bool> Original_Client) {
            return this.Update(Nome, Celular, Email, Client, Original_ContactId, Original_Nome, Original_Celular, Original_Email, Original_Client, Original_ContactId);
        }
    }
